...
leaves; targeted `rename-window -t` renames non-active target windows. Geometry
is compared with tmux through `scripts/compat_probe.sh`; complete layout
algorithms, tmux-style border rendering, zoom, and pane movement commands
remain.
