...
| Basic pane geometry | Implemented for simple horizontal/vertical splits, nested splits, targeted `resize-pane -t`, and `select-layout even-horizontal` in the probe subset |
