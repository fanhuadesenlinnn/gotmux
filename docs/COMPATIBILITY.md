...
| Basic pane geometry | Implemented for simple horizontal/vertical splits, nested splits, targeted `resize-pane -t`, and targeted `select-layout -t` built-in layouts in the probe subset |
